...
def validate_submission_requirements():
    ...
    print(f"[SUCCESS] Found {len(test_files)} test files")
    ...
    print(f"[SUCCESS] Required columns: {len(required_cols)} total")
    ...
    print(f"[SUCCESS] Required rows per file: {expected_rows_per_file} (y_0 to y_69)")
