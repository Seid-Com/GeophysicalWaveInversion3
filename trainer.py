...
class FWITrainer:
    ...
    def __init__(
        ...
        if hasattr(self.model, '__class__') and 'SimplifiedFWI' in str(self.model.__class__):
            from models.simplified_fwi import SimplifiedFWILoss
            self.criterion = SimplifiedFWILoss(data_weight=1.0, physics_weight=0.05)
        else:
